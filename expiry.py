...
searche = Entry(mwindow,width=48,fg='black',border=2,bg="white",font=('Comic Sans',10))
...
limith=Label(outputframe1,text="SET LIMIT ACCORDINGLY")
limith.place(x=690,y=30)
limit=Label(outputframe1,text="SET LIMIT : ")
...
limite1 = Entry(mwindow,width=48,fg='black',border=2,bg="white",font=('Comic Sans',10))
