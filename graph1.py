...
Button(window,image=img5,border=10,bg='teal',activebackground='#356466').place(x=100,y=135)

bgOriginal2 = Image.open('sales1.png').resize((325,200))
img6 =ImageTk.PhotoImage(bgOriginal2)
Button(window,image=img6,border=10,bg='teal',activebackground='#356466').place(x=500,y=135)
