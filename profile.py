...
Frame(frame, width=295, height=2, bg='black').place(x=200, y=175)
...
Frame(frame, width=295, height=2, bg='black').place(x=200, y=225)
...
Frame(frame, width=295, height=2, bg='black').place(x=200, y=275)
...
Frame(frame, width=295, height=2, bg='black').place(x=200, y=325)
...
Frame(frame, width=295, height=2, bg='black').place(x=200, y=375)

Button(frame, width=39, pady=7, text='Update Profile', bg='#006666', fg='white', border=0,).place(x=45,y=400)
